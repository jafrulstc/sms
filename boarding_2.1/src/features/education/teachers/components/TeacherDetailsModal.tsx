 ...
 */
const TeacherDetailsModal = memo(({ open, onClose, teacher }: TeacherDetailsModalProps) => {
              ...
              <CardContent>
                ...
                <List dense>
                  ...
                  <ListItem>
                    <ListItemText
                      primary="National ID"
                      secondary={teacher.nidNumber || 'Not specified'}
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      primary="Birth Certificate Number"
                      secondary={teacher.birthRegNumber || 'Not specified'}
                    />
                  </ListItem>
                </List>
              </CardContent>
