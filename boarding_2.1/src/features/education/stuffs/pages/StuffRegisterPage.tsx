...
//   selectStuffLoading,
//   selectStuffError,
// } from '~/features/education/stuffs/store/stuffSlice';
// import { stuffSchema, type stuffFormData } from '../schemas/stuffSchema';
...
//       role="tabpanel"
//       hidden={value !== index}
//       id={`stuff-tabpanel-${index}`}
//       aria-labelledby={`stuff-tab-${index}`}
//       {...other}
//     >
...
//   const jobRules = useAppSelector(selectJobRules);
...
//   const loading = useAppSelector(selectStuffLoading);
//   const error = useAppSelector(selectStuffError);
...
//   const onSubmit = async (data: stuffFormData) => {
//     try {
//       await dispatch(createStuff(data)).unwrap();
//       showToast(`Staff ${SUCCESS_MESSAGES.CREATED}`, 'success');
//       navigate('/admin/stuff/manage');
//     } catch (error: any) {
//       showToast(error.message || 'Failed to create staff', 'error');
//     }
//   };
...
//     return {
//       id: `stuff-tab-${index}`,
//       'aria-controls': `stuff-tabpanel-${index}`,
//     };
//   };
...
//           Register a new staff member with comprehensive information
//         </Typography>
//       </Box>
...
//             aria-label="staff registration tabs"
//             variant="scrollable"
//             scrollButtons="auto"
//           >
...
//                               value={field.value || []}
//                               label="Job Rules"
//                               options={jobRules.map(rule => ({
//                                 value: rule.id,
//                                 label: rule.name,
//                               }))}
//                               error={!!errors.jobRuleIds}
//                               helperText={errors.jobRuleIds?.message}
//                             />
//                           )}
//                         />
//                       </Grid>
...
//                               multiline
//                               rows={3}
//                               placeholder="e.g., Microsoft Office, Google Workspace"
...
//                               {...field}
//                               fullWidth
//                               label="Professional Skills/Training"
//                               multiline
//                               rows={3}
...
//                               multiline
//                               rows={4}
//                               placeholder="Any additional information about the staff..."
...
//                     sx={{ minWidth: 120 }}
//                   >
//                     {loading || isSubmitting ? 'Saving...' : 'Save Staff'}
//                   </Button>
//                 )}
//               </Box>
//             </Box>
...
// StuffRegisterPage.displayName = 'StuffManagementPage';

// export { StuffRegisterPage };