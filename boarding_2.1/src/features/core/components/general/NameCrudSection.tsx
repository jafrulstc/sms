...
interface NameCrudSectionProps {
  entityType: Exclude<GeneralEntityType, 'guardian'>;
  title: string;
}
  ...
  const getData = () => {
    switch (entityType) {
      ...
      case GENERAL_ENTITIES.DESIGNATION:
        return useAppSelector(selectDesignations);
      ...
      if (isEdit && selectedItem) {
        ...
        switch (entityType) {
          ...
          case GENERAL_ENTITIES.RELIGION:
            ...
            break;
          case GENERAL_ENTITIES.DESIGNATION:
            await dispatch(updateDesignation({ id: selectedItem.id, data: changedFields })).unwrap();
            break;
          case GENERAL_ENTITIES.JOB_RULE:
